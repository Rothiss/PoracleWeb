...
if (!isset($_POST['min_iv']) || $_POST['min_iv'] == "") {
  $_POST['min_iv'] = $monster_defaults['min_iv'];
}
if (!isset($_POST['max_iv']) || $_POST['max_iv'] == "") {
  $_POST['max_iv'] = $monster_defaults['max_iv'];
}
if (!isset($_POST['min_cp']) || $_POST['min_cp'] == "") {
  $_POST['min_cp'] = $monster_defaults['min_cp'];
}
if (!isset($_POST['max_cp']) || $_POST['max_cp'] == "") {
  $_POST['max_cp'] = $monster_defaults['max_cp'];
}
if (!isset($_POST['min_level']) || $_POST['min_level'] == "") {
  $_POST['min_level'] = $monster_defaults['min_level'];
}
if (!isset($_POST['max_level']) || $_POST['max_level'] == "") {
  $_POST['max_level'] = $monster_defaults['max_level'];
}
if (!isset($_POST['min_weight']) || $_POST['min_weight'] == "") {
  $_POST['min_weight'] = $monster_defaults['min_weight'];
}
if (!isset($_POST['max_weight']) || $_POST['max_weight'] == "") {
  $_POST['max_weight'] = $monster_defaults['max_weight'];
}
if (!isset($_POST['atk']) || $_POST['atk'] == "") {
  $_POST['atk'] = $monster_defaults['atk'];
}
if (!isset($_POST['def']) || $_POST['def'] == "") {
  $_POST['def'] = $monster_defaults['def'];
}
if (!isset($_POST['sta']) || $_POST['sta'] == "") {
  $_POST['sta'] = $monster_defaults['sta'];
}
if (!isset($_POST['max_atk']) || $_POST['max_atk'] == "") {
  $_POST['max_atk'] = $monster_defaults['max_atk'];
}
if (!isset($_POST['max_def']) || $_POST['max_def'] == "") {
  $_POST['max_def'] = $monster_defaults['max_def'];
}
if (!isset($_POST['max_sta']) || $_POST['max_sta'] == "") {
  $_POST['max_sta'] = $monster_defaults['max_sta'];
}
if (!isset($_POST['gender']) || $_POST['gender'] == "") {
  $_POST['gender'] = $monster_defaults['gender'];
}
if (!isset($_POST['size']) || $_POST['size'] == "") {
  $_POST['size'] = $monster_defaults['size'];
}
if (!isset($_POST['max_size']) || $_POST['max_size'] == "") {
  $_POST['max_size'] = $monster_defaults['max_size'];
}
...
if (!isset($_POST['pvp_ranking_best']) || $_POST['pvp_ranking_best'] == "") {
  $_POST['pvp_ranking_best'] = 1;
}

// Replace Default Values if Set
if (@$_POST['pvp_ranking_worst'] == "") {
  $_POST['pvp_ranking_worst'] = 4096;
}

if (@$_POST['pvp_ranking_min_cp'] == "") {
  if (@$_POST['league'] == 500) {
    $_POST['pvp_ranking_min_cp'] = $_SESSION['pvpFilterLittleMinCP'];
  } else {
    if (@$_POST['league'] == 1500) {
      $_POST['pvp_ranking_min_cp'] = $_SESSION['pvpFilterGreatMinCP'];
    } else {
      if (@$_POST['league'] == 2500) {
        $_POST['pvp_ranking_min_cp'] = $_SESSION['pvpFilterUltraMinCP'];
      } else {
        $_POST['pvp_ranking_min_cp'] = 0;
      }
    }
  }
}
...
if (isset($_POST['noiv']) && $_POST['noiv'] == "on") {
  $_POST['min_iv'] = "-1";
}
