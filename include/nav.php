    ...
    <div class="accordion" id="accordion-test">
      ...
      <div class="card z-depth-0 bordered">
        <div class="card-header card-header-navbar" id="heading-pages" class="heading-title">
            ...
            <tr>
              ...
              <td>
                <form action='./actions/profile.php' method='POST'>
                  ...
                  <input onChange="this.form.submit()" type="checkbox" name="alerts_toggle" id="alerts_toggle" <?php if ($enabled == "1") {
                    echo "checked";
                  } ?>
          ...
          <?php } else {
            if (isset($_SESSION['poracle_admin'])) { ?>
      ...
      <div class="card z-depth-0 bordered">
        <div class="card-header card-header-navbar" id="heading-pages" class="heading-title" data-toggle="collapse" data-target="#collapse-pages" aria-expanded="false"
      ...
      <div class="card z-depth-0 bordered">
        <div class="card-header card-header-navbar" id="heading-settings" data-toggle="collapse" data-target="#collapse-settings" aria-expanded="false"
      ...
      <?php if (isset($patreonUrl) || isset($paypalUrl)) { ?>
        <div class="card z-depth-0 bordered">
          <div class="card-header card-header-navbar" id="heading-donate" data-toggle="collapse" data-target="#collapse-donate" aria-expanded="false"
               aria-controls="collapse-donate">
            <h6 class="heading-title">
      ...
      <?php if (isset($_SESSION['admin_id']) || isset($_SESSION['poracle_admin']) || isset($_SESSION['channels_admin']) || isset($_SESSION['users_admin'])) { ?>
        ...
        <div class="card z-depth-0 bordered">
          <div class="card-header card-header-navbar" id="heading-admin" data-toggle="collapse" data-target="#collapse-admin" aria-expanded="false"
