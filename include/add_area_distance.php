...
if ($default_distance == 0) {
  $display = "none";
  $area_checked = "checked";
  $distance_checked = "";
} else {
  $display = "block";
  $area_checked = "";
  $distance_checked = "checked";
}
      ...
      <div class="input-group">
        <div class="btn-group btn-group-toggle ml-1" data-toggle="buttons" style="width:100%;">
          ...
          <label class="btn btn-secondary mr-2">
            <input type="radio" name="use_areas" id="use_areas" value="distance" <?php echo $distance_checked; ?>
                   onclick="areas_add()"><?php echo i8ln("Set Distance"); ?>
          </label>
        </div>
      </div>
...
<?php } else {
  if (@$disable_location <> "True" && @$disable_areas == "True") { ?>
    <div class="form-row align-items-center">
      <div class="col-sm-12 my-1">
        <div class="input-group">
          <div class="btn-group btn-group-toggle ml-1" data-toggle="buttons" style="width:100%;">
