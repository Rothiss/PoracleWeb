...
function setpvp(type)
{
  ...
  switch (value) {
    case '500':
      var min = document.querySelector('input[id="pvpFilterLittleMinCP"]').value
      break
    case '1500':
      var min = document.querySelector('input[id="pvpFilterGreatMinCP"]').value
      break
    case '2500':
      var min = document.querySelector('input[id="pvpFilterUltraMinCP"]').value
      break
  }
