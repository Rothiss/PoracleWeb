      ...
      <div id="content">
        ...
        <div class="container-fluid col-lg-8 col-md-12">
          ...
          <h4 class="modal-title m-2">
            <center><?php echo i8ln("Channel Synchronization"); ?></center>
            <hr>
          </h4>

          <h6 class="modal-title m-2">
            <p>
            <center><?php echo i8ln("Please select channels you want to synchronize with current channel"); ?></center>
            </p>
            <p>
            <center><font color="darkred"><strong>
