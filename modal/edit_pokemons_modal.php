...
if ($row['min_iv'] == $monster_defaults['min_iv']) {
  $row['min_iv'] = "";
}
if ($row['max_iv'] == $monster_defaults['max_iv']) {
  $row['max_iv'] = "";
}
if ($row['min_cp'] == $monster_defaults['min_cp']) {
  $row['min_cp'] = "";
}
if ($row['max_cp'] == $monster_defaults['max_cp']) {
  $row['max_cp'] = "";
}
if ($row['min_level'] == $monster_defaults['min_level']) {
  $row['min_level'] = "";
}
if ($row['max_level'] == $monster_defaults['max_level']) {
  $row['max_level'] = "";
}
if ($row['min_weight'] == $monster_defaults['min_weight']) {
  $row['min_weight'] = "";
}
if ($row['max_weight'] == $monster_defaults['max_weight']) {
  $row['max_weight'] = "";
}

if ($row['pvp_ranking_best'] == $monster_defaults['pvp_ranking_best']) {
  $row['pvp_ranking_best'] = "";
}
if ($row['pvp_ranking_worst'] == $monster_defaults['pvp_ranking_worst']) {
  $row['pvp_ranking_worst'] = "";
}
if ($row['pvp_ranking_min_cp'] == $monster_defaults['pvp_ranking_min_cp']) {
  $row['pvp_ranking_min_cp'] = "";
}
          ...
          <div class="col-sm-12 my-1">
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              ...
              foreach ($pvpCaps as $key => $cap) {
                ...
                ?>
                <label class="btn btn-secondary">
                  <input type="radio" name="cap" id="cap_<?php echo $cap; ?>"
                         value="cap_<?php echo $cap; ?>" <?php echo $checked; ?>><?php echo i8ln($display_cap); ?>
                </label>
              <?php } ?>
            </div>
          </div>
