...
<div class="tab-content mb-5" id="pills-tab-homeContent">
  <?php if (@$disable_mons <> "True") { ?>
    <div class="tab-pane fade show active" id="pills-mons" role="tabpanel" aria-labelledby="pills-mons-tab">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <a href="./actions/monsters.php?action=delete_all_mons" class="btn btn-danger"><?php echo i8ln("DELETE"); ?></a>
      ...
      <div class="modal fade" id="DistanceMonsModal" tabindex="-1" role="dialog" aria-labelledby="DistanceMonsModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <?php include "./modal/distance_pokemon_modal.php"; ?>
          </div>
        </div>
      </div>
      ...
      if (@$_GET['gen'] == "all") {
        $gen_selector = "AND pokemon_id = 0";
      }

      if (@$_GET['gen'] == 1) {
        $gen_selector = "AND pokemon_id between 1 and 151";
      }

      if (@$_GET['gen'] == 2) {
        $gen_selector = "AND pokemon_id between 152 and 251";
      }

      if (@$_GET['gen'] == 3) {
        $gen_selector = "AND pokemon_id between 252 and 386";
      }

      if (@$_GET['gen'] == 4) {
        $gen_selector = "AND pokemon_id between 387 and 493";
      }

      if (@$_GET['gen'] == 5) {
        $gen_selector = "AND pokemon_id between 494 and 649";
      }

      if (@$_GET['gen'] == 6) {
        $gen_selector = "AND pokemon_id between 650 and 721";
      }

      if (@$_GET['gen'] == 7) {
        $gen_selector = "AND pokemon_id between 722 and 809";
      }

      if (@$_GET['gen'] == 8) {
        $gen_selector = "AND pokemon_id between 810 and 905";
      }

      if (@$_GET['gen'] == 9) {
        $gen_selector = "AND pokemon_id >= 906";
      }
          ...
          <ul class="pagination justify-content-left ml-1">
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=all">
                <center>
                  <small><b><?php echo i8ln("ALL"); ?></b><br><?php echo $genall; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=1">
                <center>
                  <small><b>G1</b><br><?php echo $gen1; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=2">
                <center>
                  <small><b>G2</b><br><?php echo $gen2; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=3">
                <center>
                  <small><b>G3</b><br><?php echo $gen3; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=4">
                <center>
                  <small><b>G4</b><br><?php echo $gen4; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=5">
                <center>
                  <small><b>G5</b><br><?php echo $gen5; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=6">
                <center>
                  <small><b>G6</b><br><?php echo $gen6; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=7">
                <center>
                  <small><b>G7</b><br><?php echo $gen7; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=8">
                <center>
                  <small><b>G8</b><br><?php echo $gen8; ?></small>
                </center>
              </a>
            </li>
            <li class="page-item <?php
            ...
            ?>">
              <a class="page-link gen-link" href="?type=display&page=pokemon&gen=9">
                <center>
                  <small><b>G9</b><br><?php echo $gen9; ?></small>
                </center>
              </a>
            </li>
          </ul>
      ...
      <div class="row">
        ...
        while ($row = $result->fetch_assoc()) {
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col">
                    ...
                    <?php } else { ?>
                      ...
                      <?php $form_name = get_form_name($row['pokemon_id'], $row['form']); ?>
                      <div>
                                                <span class="badge badge-primary badge-pill w-100">
                                                    <?php echo $row['pokemon_id']
                                                      . " | "
                                                      . $pokemon_name
                                                      . " "
                                                      . i8ln($form_name);
                    ...
                    <ul class="list-group mt-2">
                      ...
                      <?php if ($row['min_iv'] <> '-1' || $row['max_iv'] <> '100') { ?>
                        <li
                      ...
                      <?php if ($row['min_cp'] <> '0' || $row['max_cp'] <> '9000') { ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <?php echo i8ln("CP"); ?>
                          <span class="badge badge-primary badge-pill">
                                                        <?php echo $row['min_cp']; ?>
                      ...
                      <?php if ($row['min_level'] <> '0' || $row['max_level'] < '40') { ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <?php echo i8ln("LEVEL"); ?>
                          <span class="badge badge-primary badge-pill">
                                                        <?php echo $row['min_level']; ?>
                                                        -
                                                        <?php echo $row['max_level']; ?>
                                                    </span>
                        </li>
                      <?php } ?>
                      ...
                      <?php if ($row['atk'] <> '0'
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <?php echo i8ln("STATS"); ?>
                          <span class="badge badge-primary badge-pill">
                                                        <?php echo $row['atk'] . "/" . $row['def'] . "/" . $row['sta']; ?>
                                                        -
                                                        <?php echo $row['max_atk'] . "/" . $row['max_def'] . "/" . $row['max_sta']; ?>
                                                    </span>
                        </li>
                      <?php } ?>

                      <?php if ($row['pvp_ranking_league'] > 0) { ?>
                        <li
                          class="list-group-item d-flex justify-content-between align-items-center">
                          <?php
                          ...
                          if ($row['pvp_ranking_league'] == 1500) {
                            echo i8ln("GREAT");
                          }

                          if ($row['pvp_ranking_league'] == 2500) {
                            echo i8ln("ULTRA");
                          }
                          ?>
                          <span class="badge badge-primary badge-pill">
                                                        top
                                                        <?php if ($row['pvp_ranking_worst'] <> $row['pvp_ranking_best']) {
                                                          echo $row['pvp_ranking_best'] . "-";
                                                        } ?>
                            <?php echo $row['pvp_ranking_worst']; ?>
                                                        @<?php echo $row['pvp_ranking_min_cp']; ?>
                                                    </span>
                        </li>
                      <?php } ?>

                      <?php if ($row['pvp_ranking_cap'] <> '0') { ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <?php echo i8ln("PvP Cap"); ?>
                          <span class="badge badge-primary badge-pill">
                                                        <?php echo $row['pvp_ranking_cap']; ?>
                                                    </span>
                        </li>
                      <?php } ?>

                      <?php if ($row['min_weight'] <> '0' || $row['max_weight'] <> '9000000') { ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <?php echo i8ln("WEIGHT"); ?>
                          <span class="badge badge-primary badge-pill">
                                                        <?php echo $row['min_weight']; ?>
                                                        -
                                                        <?php if ($row['max_weight'] == '9000000') {
                                                          echo "MAX";
                                                        } else {
                                                          echo $row['max_weight'];
                                                        } ?>
                      ...
                      <?php if ($row['size'] <> '-1') { ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <?php echo i8ln("SIZE"); ?>
                          <span class="badge badge-primary badge-pill">
                                                        <?php echo get_size_name($row['size']); ?>
                                                        <?php if ($row['max_size'] <> $row['size']) {
                    ...
                    <?php if ($row['clean'] == '1' && $all_mon_cleaned == '0') { ?>
                      <div class="mt-1">
                                                <span class="badge badge-pill badge-info w-100">
                                                    <?php echo i8ln("Cleaning Activated"); ?>
                                                </span>
                      </div>
                    <?php } ?>

                    <?php if ($enable_templates == "True") { ?>
                      <div class="mt-1">
                        <?php
          ...
          <div class="modal fade" id="<?php echo $unique_id; ?>Modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <?php include "./modal/edit_pokemon_modal.php"; ?>
              </div>
            </div>
          </div>
