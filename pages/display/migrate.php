...
<center>
  ...
  <p class="mb-2"><?php echo i8ln("You are currently connected as"); ?>
  <p>

    <button class="btn btn-<?php if ($_SESSION['type'] == 'discord:user') {
      echo "primary";
    } else {
      echo "info";
    } ?> btn-icon-split m-1">
    ...
    <?php if (!isset($_GET['username'])) {
      $_GET['username'] = $_GET['first_name'] . " " . $_GET['last_name'];
    } ?>
  ...
  <a href='<?php echo $redirect_url; ?>'>
    <button class="btn btn-primary" style="width:300px;">Back to PoracleWeb</button>
  </a>

  <?php } else { ?>

    <p class="mb-2"><?php echo i8ln("Your account will be migrated to"); ?>
    <p>
    ...
    <hr>
    <p class="mb-2"><?php echo i8ln("Migration is definitive and cannot be reversed"); ?>!
    <p>
