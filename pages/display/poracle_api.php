...
<div class="tab-pane fade active show" role="tabpanel">
  ...
  <center><strong>
      ...
      <?php echo i8ln("Update from Poracle config file"); ?>: local.json
      <hr>
    </strong></center>
    ...
    <div class="col-sm-12 my-1">
      <div class="input-group">
        ...
        <div class="form-control text-center">
          <?php if ($_SESSION['maxDistance'] == 10726000) {
            echo i8ln("Unlimited") . " (10.726 km)";
          } else {
            echo $_SESSION['maxDistance'];
          } ?>
        </div>
      </div>
    </div>
  ...
  <div class="form-row align-items-center">
    ...
    <div class="col-sm-12 my-1">
      <div class="input-group">
        ...
        <div class="form-control text-center">
          <?php if ($_SESSION['staticKey'] <> "Your MapQuest or Google Key") {
            echo $_SESSION['staticKey'];
          } ?>
        </div>
      </div>
    </div>
        ...
        <div class="form-control text-center" style="height:auto;">
          ...
          foreach ($_SESSION['poracle_admins'] as $key => $padmin) {
            ...
            while ($row = $result->fetch_assoc()) {
              if ($row['type'] == "discord:user") {
                $color = "primary";
              } else {
                if ($row['type'] == "telegram:user") {
                  $color = "info";
                }
              }
