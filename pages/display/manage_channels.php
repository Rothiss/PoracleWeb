      ...
      <div id='discord' class='areasform text-uppercase text-center'>
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
          ...
          <?php if (isset($_SESSION['admin_id'])
            || isset($_SESSION['poracle_admin'])
            || in_array($row['id'], $_SESSION['delegated_channels']['discord']['channels'])) { ?>
    ...
    <?php if ($result->num_rows <> 0) { ?>
      ...
      <div id='discord' class='areasform text-uppercase text-center'>
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
          ...
          <?php if (isset($_SESSION['admin_id'])
            || isset($_SESSION['poracle_admin'])
            || in_array($row['id'], $_SESSION['delegated_channels']['telegram']['channels'])) { ?>
    ...
    <?php if ($result->num_rows <> 0) { ?>
      ...
      <div id='discord' class='areasform text-uppercase text-center'>
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
          ...
          <?php if (isset($_SESSION['admin_id'])
            || isset($_SESSION['poracle_admin'])
            || in_array($row['name'], $_SESSION['delegated_channels']['discord']['webhooks'])) { ?>
