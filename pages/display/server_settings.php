  ...
  <div class="tab-pane fade active show" id="pills-lures" role="tabpanel" aria-labelledby="pills-lures-tab">
    ...
    if ($api_result['status'] == "ok") {
      if (version_compare($_SESSION['poracleVersion'], $min_poracle_version) < 0) {
        ...
        if (version_compare($_SESSION['poracleVersion'], $PJSversion) < 0) {
    ...
    <div class="form-row align-items-center">
      ...
      <?php if (!isset($source_raid_bosses)) {
        $source_raid_bosses = "DB";
      } ?>
      <div class="col-sm-12 my-1">
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
          <div class="input-group">
          ...
          <label class="btn btn-secondary">
            <input type="radio" name="source_raid_bosses" id="source_raid_bosses" value="JSON"
              <?php if ($source_raid_bosses == "JSON") {
                echo "checked";
              } ?>>
            <?php echo i8ln("JSON"); ?>
          </label>
  ...
  <div class="tab-pane fade active show" id="pills-lures" role="tabpanel" aria-labelledby="pills-lures-tab">
    ...
    <div class="row">
      ...
      <?php foreach ($uicons_repos as $repo_name => $repo_url) { ?>
        ...
        <?php if ($uicons_pkmn == $repo_url) {
          $checked_pkmn = "checked";
        } else {
          $checked_pkmn = "";
        } ?>
        <?php if ($uicons_raid == $repo_url) {
          $checked_raid = "checked";
        } else {
          $checked_raid = "";
        } ?>
        <?php if ($uicons_gym == $repo_url) {
          $checked_gym = "checked";
        } else {
          $checked_gym = "";
        } ?>
        <?php if ($uicons_reward == $repo_url) {
          $checked_reward = "checked";
        } else {
          $checked_reward = "";
        } ?>
    ...
    <div class="tab-pane fade active show" id="pills-lures" role="tabpanel" aria-labelledby="pills-lures-tab">
      ...
      <div class="tab-pane fade active show" id="pills-lures" role="tabpanel" aria-labelledby="pills-lures-tab">
        ...
        <div class="row">
          ...
          <!-- Card -->
          <?php if (@$disable_geomap_select <> "True") {
            $border = "border-success";
          } else {
            $border = "border-danger";
          } ?>
