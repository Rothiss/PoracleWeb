...
<div class="row">
    ...
    <div class="col-xl-12 col-sm-12 col-12">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
          <strong>
            <center><?php echo i8ln("Common Trackings"); ?></center>
          </strong>
        </div>
        ...
        <div class="card-body mb-2">
          ...
          <div class="row d-flex justify-content-between align-items-center pl-3 pr-3">
            ...
            $sql = "select uid FROM monsters WHERE min_iv = 0 AND max_iv = 0 AND pokemon_id = 0 AND id = '"
              . $_SESSION['id']
              . "' AND profile_no = '"
              . $_SESSION['profile']
              . "'";
            ...
            <?php
            $sql = "select uid FROM monsters WHERE pokemon_id = 0 AND pvp_ranking_league = 500 AND pvp_ranking_worst = 1 AND id = '"
              . $_SESSION['id']
              . "' AND profile_no = '"
              . $_SESSION['profile']
              . "'";
            ...
            <form action='./actions/quick_pick.php' method='POST' class="w-100">
              <div class="input-group mt-2 justify-content-center">
                <div class="input-group-text mr-1 justify-content-center"
                     style="min-width:80%; <?php echo $style; ?>"><?php echo i8ln("PvP Little Rank 1"); ?></div>
                <input type='hidden' id='clean' name='clean' value='<?php echo $mon_cleaned; ?>'>
                <input type='hidden' id='distance' name='distance' value='<?php echo $mon_distance; ?>'>
            ...
            <?php
            $sql = "select uid FROM monsters WHERE pokemon_id = 0 AND pvp_ranking_league = 1500 AND pvp_ranking_worst = 1 AND id = '"
              . $_SESSION['id']
              . "' AND profile_no = '"
              . $_SESSION['profile']
              . "'";
            ...
            <?php
            $sql = "select uid FROM monsters WHERE pokemon_id = 0 AND pvp_ranking_league = 2500 AND pvp_ranking_worst = 1 AND id = '"
              . $_SESSION['id']
              . "' AND profile_no = '"
              . $_SESSION['profile']
              . "'";
  ...
  <div class="col-xl-12 col-sm-12 col-12">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3">
        <strong>
          <center><?php echo i8ln("Magikarps & Ratatas"); ?></center>
        </strong>
      </div>
      ...
      <div class="card-body mb-2">
        ...
        <div class="row d-flex justify-content-between align-items-center pl-3 pr-3">
          ...
          <?php
          $sql = "select uid FROM monsters WHERE pokemon_id = 129 AND min_weight = 13130 AND id = '"
            . $_SESSION['id']
            . "' AND profile_no = '"
            . $_SESSION['profile']
            . "'";
          ...
          <?php
          $sql = "select uid FROM monsters WHERE pokemon_id = 19 AND max_weight = 2410 AND id = '"
            . $_SESSION['id']
            . "' AND profile_no = '"
            . $_SESSION['profile']
            . "'";
  ...
  <div class="col-xl-12 col-sm-12 col-12">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3">
        <strong>
          <center><?php echo i8ln("XXS & XXL Pokemon"); ?></center>
        </strong>
      </div>
      ...
      <div class="card-body mb-2">
        ...
        <div class="row d-flex justify-content-between align-items-center pl-3 pr-3">
          ...
          <?php
          $sql = "select uid FROM monsters WHERE size = 1 AND max_size = 1 AND pokemon_id = 0 AND id = '"
            . $_SESSION['id']
            . "' AND profile_no = '"
            . $_SESSION['profile']
            . "'";
